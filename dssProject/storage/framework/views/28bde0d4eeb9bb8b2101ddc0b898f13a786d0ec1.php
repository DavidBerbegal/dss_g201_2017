...
<html lang="<?php echo e(config('app.locale')); ?>">
    ...
    <body>
        ...
        <form action="<?php echo e(action('UsersController@createUser')); ?>" name="create"
            method="POST">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>"><br><br></td>
                </tr>
                <tr>
                    <td><label for="email">Email: </label></td>
                    <td><input type="text" name="email" id="email" value="<?php echo e(old('email')); ?>">
                    <br><br></td>
                <tr>
                    <td><label for="password">Password: </label></td>
                    <td><input type="text" name="password" id="password" value="<?php echo e(old('password')); ?>"><br><br></td>
                </tr>
            </table>
