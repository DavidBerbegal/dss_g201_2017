...
<html lang="<?php echo e(config('app.locale')); ?>">
    ...
    <br>
            ...
            <div class="flex-center"><form action="<?php echo e(action('UsersController@updateUser')); ?>" name="update"
                method="POST">
                <?php echo e(csrf_field()); ?>

                <table>
                    <tr>
                        <td><label for="id">ID del usuario: <?php echo e($id); ?></label><br><br></td>
                        <td><input type="hidden" name="id" id="id" value = <?php echo e($id); ?>></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="email" id="email" value= <?php echo e($email); ?>><br><br></td>
                    </tr>
                    <tr>
                        <td><label for="password">Password:</label></td>
                        <td><input type="text" name="password" id="password" value= <?php echo e($password); ?>><br><br></td>
                    </tr>
                </table>
