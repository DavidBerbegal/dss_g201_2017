...
<html lang="<?php echo e(config('app.locale')); ?>">
    ...
    <body>
            ...
            <div class="flex-center"><div>
                ...
                <?php endif; ?>
                <div class="flex-center"><div>
                   <form action="<?php echo e(action('suscripcionFuentesController@index')); ?>" name="sortBy"
                     method="GET">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(sizeof($sourcesubscriptions) == 0): ?>
                        <br>
                        <br>
                        <div><h3>No hay coincidencias para estos criterios de búsqueda</h3></div>
                    <?php endif; ?>
                    
                    <?php $__currentLoopData = $sourcesubscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($sub->id); ?></td>
                            <td><?php echo e($sub->user_id); ?></td>
                            <td><?php echo e($sub->source_id); ?></td>
                            
                                <td>    
                                    <a>
                                        <form action="<?php echo e(action('suscripcionFuentesController@delete', ['id' =>  $sub->id ])); ?>" name="delete"
                                            method="POST">
                ...
                <div class="flex-center">
                    <?php echo e($sourcesubscriptions->appends(['order' => $order])->links()); ?>
