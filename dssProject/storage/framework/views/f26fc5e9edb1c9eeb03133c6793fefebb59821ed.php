...
<html lang="<?php echo e(config('app.locale')); ?>">
    ...
    <br>
            ...
            <div class="flex-center"><form action="<?php echo e(action('categoriasController@update')); ?>" name="update"
                method="POST">
                <?php echo e(csrf_field()); ?>

                <table>
                    <tr>
                        <td><label for="id">ID de la categoría: <?php echo e($id); ?></label><br><br></td>
